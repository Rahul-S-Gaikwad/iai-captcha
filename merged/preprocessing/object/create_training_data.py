"""Data preprocessing for object CAPTCHAs"""
...
def create():
    image_list, label_list = load_images_and_labels(os.path.join(config.RAW_DIR, "object"))
    ...
    save_images_to_folder(os.path.join(config.VAL_DIR, "object"), X_val, Y_val)
    ...
    save_images_to_folder(os.path.join(config.TRAIN_DIR, "object"), X_augmented, Y_augmented)

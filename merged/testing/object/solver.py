...
import image_extractor as image_extractor
...
class Solver:
    def __init__(self, network_path=MODEL_PATH, encoding_path=os.path.join(config.MODELS_DIR, "object", config.MODEL_LABELS_FILENAME)):

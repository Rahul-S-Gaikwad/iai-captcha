...
class Solver:
    def __init__(self, network_path=MODEL_PATH, encoding_path=os.path.join(config.MODELS_DIR, "text", config.MODEL_LABELS_FILENAME)):
    ...
    def solve(self, img_file):
        ...
        for letter_image in letter_images:
            ...
            letter_image = image_splitter.resize_to_fit(letter_image, 35, 35)
